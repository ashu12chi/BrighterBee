...
class _AdminControlPanelState extends State<AdminControlPanel> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Admin Control Panel',style: TextStyle(fontWeight: FontWeight.bold),)),
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                Padding(
                                  ...
                                  child: Text('Add admins',style: TextStyle(fontSize: 16),),
                                ),
                          ...
                          child: Card(
                            child: Column(
                              ...
                              children: <Widget>[
                                Padding(
                                  padding: const EdgeInsets.only(top:8.0,bottom: 8.0,left: 20,right: 20),
                                  child: Text('View admins',style: TextStyle(fontSize: 16),),
                                ),
                                Icon(Icons.person)
                              ],
                            ),
